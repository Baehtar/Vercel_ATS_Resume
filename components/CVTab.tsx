  ...
  const generateSummary = async () => {
    ...
    try {
      ...
      if (data.summary) {
        ...
        setNote(
          data.api_used
            ? { kind: "success", text: "Recruiter summary generated by OpenAI." }
            : {
                kind: "warning",
                text: `Fallback recruiter summary generated; AI unavailable${
                  data.api_error ? ` — ${data.api_error}` : ""
                }.`,
              }
        );
      } else {
        setNote({ kind: "error", text: "Could not generate a recruiter summary." });
      }
    } catch (e) {
    ...
    <div>
      ...
      <div className="cv-layout" style={{ marginTop: 16 }}>
        ...
        <div>
          ...
          {/* Recruiter Summary — generated last so it reflects the full resume */}
          <details className="expander" open>
            ...
            <div className="expander-body">
              ...
              <button className="btn-cta full" onClick={generateSummary} disabled={summaryBusy} style={{ marginTop: 8 }}>
                {summaryBusy && <span className="spinner" />}Generate Recruiter Summary
              </button>
            </div>
          </details>
